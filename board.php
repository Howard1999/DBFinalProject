<?php
	...
	// check board and page
	if(isset($_GET["board_name"])&&isset($_GET["page"])){
		//check board exist
		...
		if($stmt->fetch()){
			...
			if((0<$_GET["page"]&&$_GET["page"]<=$total_page)||(1==$_GET["page"])){
				$_SESSION["last view page"] = $_GET["page"];
			}
			else{
